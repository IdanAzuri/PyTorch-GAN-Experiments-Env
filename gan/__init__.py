...
class GAN:
	...
	def _train_epoch(self, data_loader):
		...
		for curr_step_count, (images, _) in enumerate(train_loader):
	...
	def _train_discriminator(self, discriminator, images, real_labels, fake_images=None, fake_labels=None):
	...
	def build_criterion(self):
		return torch.nn.BCELoss()  # Binary cross entropy
	...
	def build_optimizers(self, discriminator, generator):
		...
		g_optimizer = torch.optim.Adam(generator.parameters(), lr=Config.train.g_learning_rate, betas=Config.train.optim_betas)
